        ...
        <html>
            ...
            <section>
                <form class="form_edit" method="post" action="../Controllers/Contratos_Controller.php" enctype="multipart/form-data" onsubmit="return validacionSubmitEdit();">
                    ...
                    <!--Inputs de datos autoexplicativos-->
                    <fieldset id="fieldset_edit">
                        ...
                        <select>
                            <?php if ($datos['tipo'] == 'certificador') {
                                ...
                                <option value="reparacion" ><?php echo $strings['Reoaracion'] ?></option>
                                <?php
                            }
                            ...
                            if ($datos['tipo'] == 'reparacion') {
                                ...
                                <option value="certificador"><?php echo $strings['Certificador'] ?></option>
                                <option value="mantenimiento"><?php echo $strings['Mantenimiento'] ?></option>
                                <option value="reparacion" selected><?php echo $strings['Reoaracion'] ?></option>
                            <?php } else { ?>
                                <option value="certificador"><?php echo $strings['Certificador'] ?></option>
                                <option value="mantenimiento"><?php echo $strings['Mantenimiento'] ?></option>
                                <option value="reparacion"><?php echo $strings['Reoaracion'] ?></option>
                        ...
                        <label for="resguardo"><?php echo $strings['cifEmpresa']; ?>  *</label> 
                        <input name="resguardo" type="file" id="editresguardo" /> <!--No se valida el resguardo en edit porque si no se introduce un fichero nuevo nos quedamos con el que ya esta almacenado-->
