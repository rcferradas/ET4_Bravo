<!--17-01-2019/Bravo/Vista que nos muestra todas las visitas pendientes que tiene un contrato
y permite pagar el contrato si están todas realizadas-->

<?php

class Pagar_Contrato_View {
    ...
    function render($recordSet) {
        ...
        ?>
            ...
            <div>
                <h2><?php echo $strings['Deben realizarse estas visitas antes del pago']; ?></h2>
