...
/*Comprueba que todos los campos obligatorios estén escritos y que todos los campos escritos estén cubiertos correctamente,se envía en Visitas_ADD_view */
/*En el momento que correcto sea 1 significará que algún campo no es correcto*/
function validarVisitasADD(Formu){
    var correcto=0;
        if(!comprobarVacio(Formu.informeAdd1)){//comprobamos que el informe no esté vacío
            correcto = 1;
        }
        if(!comprobarVacio(Formu.fechaAdd1)){//comprobamos que la fecha no esté vacío
            correcto = 1;
        }
	if(correcto==0){	
            return true;
...
/*Comprueba que todos los campos obligatorios estén escritos y que todos los campos escritos estén cubiertos correctamente,se envía en Visitas_Incidencia_view */
/*En el momento que correcto sea 1 significará que algún campo no es correcto*/
function validarVisitasIncidencia(Formu){
    var correcto=0;
        if(!comprobarVacio(Formu.informeAdd1)){//comprobamos que la informe no esté vacío
            correcto = 1;
        }        
        if(!comprobarVacio(Formu.fechaAdd1)){//comprobamos que la fecha no esté vacío
            correcto = 1;
